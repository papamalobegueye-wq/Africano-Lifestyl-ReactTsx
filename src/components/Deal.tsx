        ...
        <section className="deal-card w-full p-5 mt-15 gap-10">
            <div className=" flex flex-col md:flex-row items-center justify-center w-full max-w-5xl mx-auto 
                ...
                <div className=" flex flex-col md:gap-4 gap-2 text-center md:text-left w-full md:w-auto">
                    <h2 className="font-jost font-semibold text-3xl md:text-3xl">Deals of the Month</h2>

                    <p className="w-full md:w-120 text-sm font-jost">Pourquoi choisir entre tradition et modernité quand on peut incarner les deux ?
                        Notre nouvelle collection célèbre l’homme d'influence, celui qui respecte ses 
                        racines tout en imposant sa propre vision du futur.</p>
                    ...
                    <div className="flex gap-4 mt-8">
                        ...
                        { label: "Secs", value: timeLeft.seconds },
                            ...
                            <div key={index} className="flex flex-col items-center justify-center w-20 h-20 bg-white shadow-lg rounded-xl border border-slate-100">
                       ...
                       <div>
                            <button className="font-jost mt-2  bg-black text-white w-40 rounded-lg hover:bg-gray-800 py-2">View All Products</button>
